    ...
    <div class="login-box">
      ...
      <div class="card">
        <div class="card-body login-card-body">
          <h4 class="login-box-msg text-success">GSL</h4>
          ...
          <div class="row">
            <div class="col">
             <h6 align="" class="text-success"><small><i class="fas fa-copyright"></i> <?= date("Y") ?></small></h6> 
            </div>
            <div class="col">
             <h6 align="right" class="text-success"><small>Ratovonirina</small></h6> 
            </div>
          </div>
        </div>
      </div>
